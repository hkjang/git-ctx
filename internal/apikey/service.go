...
func validateScopes(scopes []string) error {
	allowed := map[string]bool{
		...
		"search-repositories": true, "search-source": true, "search-code": true, "find-file": true, "read-file": true, "get-file-history": true, "list-directory": true, "search-merge-requests": true,
