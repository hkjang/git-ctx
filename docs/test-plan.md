...
```bash
scripts/package-offline-image.sh 0.77.13 git-ctx:v0.77.13
scripts/verify-offline-image.sh 0.77.13 dist/git-ctx-v0.77.13.tar.gz <릴리스-커밋-SHA>
```
